...
from markdown_sections import normalize_heading, iter_headings
...
class TestExtractSectionByHeading:
    ...
    def test_extracts_section_by_title(self):
        ...
        from markdown_sections import extract_section_by_heading
        md = """## First Section
...
class TestCoverageCheck:
    ...
    def test_identifies_covered_headings(self):
        ...
        from markdown_sections import coverage_check
        md = """## A
## B
## C
"""
